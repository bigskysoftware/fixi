...
The current uncompressed size is `3473` bytes, the gzipped size is `1473` bytes and the brotli'd size is `1278` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.9.4/fixi.js >> fixi-0.9.4.js
```

The SHA256 of v0.9.4 is 

`rPuE58bCyMrZ37o4bByX4epgBA1bAeTylp7TxOXVh90=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.9.4.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.9.4/fixi.js"
