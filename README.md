...
The current uncompressed size is `3621` bytes and the gzip'd size is `1375` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.1.1/fixi.js >> fixi-0.1.1.js
```

The SHA256 of v0.1.1 is 

`yp6mPb3XNbe9nKlJLc8X0eqC5CeQivPSUH4opmD02sA=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.1.1.zip>
